...
照片墙采用**新野兽派（Neo-Brutalism）**设计美学，这是一种强调原始感、高对比度和手工质感的设计风格：

### 设计特点

| 元素 | 说明 |
|------|------|
| **高对比配色** | 鲜艳便利贴色（红、青、黄、蓝、粉、紫）搭配深色边框 |
| **粗粝边框** | 4px 实线边框，打破传统细线设计 |
| **硬阴影** | 8px 偏移阴影，营造立体印刷效果 |
| **胶带装饰** | 半透明胶带元素，模拟真实便利贴 |
| **噪点纹理** | 细微噪点叠加，增加复古质感 |
