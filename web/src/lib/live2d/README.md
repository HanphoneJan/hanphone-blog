...
- **渲染引擎**: PIXI.js v7.4.2
- **Live2D 库**: pixi-live2d-display-advanced v1.1.0
...
`pixi-live2d-display-advanced` 需要 Cubism 运行时先加载到全局环境。在 `useLive2DModel.ts` 中：
...
- [PIXI.js 官方文档](https://pixijs.com/7.x/tutorials/getting-started)
