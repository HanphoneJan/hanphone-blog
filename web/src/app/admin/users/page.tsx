                      ...
                      <div className="lg:hidden">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3 flex-1 min-w-0">
                            ...
                            <div className="min-w-0 flex-1">
                              <div className="font-medium text-[rgb(var(--primary))] text-sm truncate flex items-center gap-1">
                                {user.nickname}
                                {user.githubId && (
                                  <span title="已绑定 GitHub">
                                    <svg className="h-3 w-3 inline-block text-[rgb(var(--muted))]" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        {expandedUsers.has(user.id) && (
                          <div className="mt-3 pt-3 border-t border-[rgb(var(--border))] space-y-2 text-sm">
                            ...
                            {user.githubId && (
                              <div className="flex items-center gap-2">
                                <svg className="h-4 w-4 text-[rgb(var(--muted))] shrink-0" viewBox="0 0 24 24" fill="currentColor">
                                  <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" />
                                </svg>
                                <span className="text-[rgb(var(--text-muted))] min-w-[60px]">GitHub：</span>
                                <span className="text-[rgb(var(--text))] truncate">已绑定</span>
                              </div>
                            )}
                          </div>
                        )}
                      ...
                      <div className="hidden lg:grid grid-cols-12 gap-4 items-center">
                        ...
                        <div className="col-span-2 flex items-center gap-3">
                          ...
                          <div className="min-w-0">
                            <div className="font-medium text-[rgb(var(--primary))] truncate flex items-center gap-1.5">
                              {user.nickname}
                              {user.githubId && (
                                <span title="已绑定 GitHub">
                                  <svg className="h-3.5 w-3.5 inline-block text-[rgb(var(--muted))]" viewBox="0 0 24 24">
                                  <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" />
                                </svg>
                              </span>
                              )}
              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="relative w-16 h-16 rounded-full overflow-hidden border border-[rgb(var(--border))] shrink-0">
                    ...
                    />
                    {uploadingAvatar && (
                      <div className="absolute inset-0 bg-[rgb(var(--overlay))]/50 flex items-center justify-center">
