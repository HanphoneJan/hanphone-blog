...
export default function CategoryManagement() {
  ...
  return (
    ...
    >
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-2">
                {filteredCategoryList.map((category, index) => (
                  ...
                  <motion.div
                    ...
                    className="bg-[rgb(var(--card))] border border-[rgb(var(--border))] rounded-lg px-3 py-2 lg:p-4 hover:bg-[rgb(var(--hover))] transition-all duration-150 hover:shadow-md hover:border-[rgb(var(--primary))]/30 relative group"
                  >
                    {/* 操作按钮（悬停显示） */}
                  ...
                  {fileList.length > 0 ? (
                    <div className="relative">
                      ...
                      <button
                        ...
                        className="absolute top-2 right-2 bg-[rgb(var(--overlay))]/50 p-1 rounded-full text-white hover:bg-[rgb(var(--overlay))]/70 transition-colors"
                      >
                        <X className="h-4 w-4" />
                      </button>
                      <button
      ...
      {/* 图片预览对话框 */}
      {previewVisible && (
        <div className="fixed inset-0 bg-[rgb(var(--overlay))]/50 flex items-center justify-center z-50 p-4">
