                        ...
                        >
                          {dialogImageUrl ? (
                            <div className="relative w-full h-full rounded-lg overflow-hidden">
                              ...
                              />
                              <div className="absolute inset-0 bg-[rgb(var(--overlay))]/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                              ...
                              <button
                                ...
                                className="absolute top-2 right-2 bg-[rgb(var(--overlay))]/70 text-white p-1.5 rounded-full hover:bg-red-600 transition-colors duration-200"
                              >
                                <X className="h-4 w-4" />
                              </button>
                            </div>
            ...
            <div className="fixed inset-0 flex items-center justify-center z-52 p-4">
              ...
              <div className="relative z-10 max-w-4xl w-full animate-in fade-in zoom-in duration-200">
                <button
                  ...
                  className="absolute -top-12 right-0 text-white hover:text-[rgb(var(--text-muted))] transition-colors bg-[rgb(var(--overlay))]/50 p-2 rounded-full hover:bg-[rgb(var(--overlay))]/70"
                >
                  <X className="h-6 w-6" />
                </button>
