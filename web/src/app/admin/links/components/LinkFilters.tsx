    ...
    <div className="md:mb-4 p-3 bg-[rgb(var(--card))]/60 lg:rounded-lg border-[rgb(var(--border))]">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="space-y-1 md:col-span-2">
          <label className="block text-xs text-[rgb(var(--muted))]">名称搜索</label>
      ...
      <div className="mt-3 flex justify-between items-center">
        <div className="text-xs text-[rgb(var(--muted))]">
          共 {filteredCount} 个友链（筛选自 {totalCount} 个友链）
        </div>

        <button
          onClick={onReset}
          className="px-3 py-1 rounded-md border-[rgb(var(--border))] bg-[rgb(var(--card))] text-[rgb(var(--text))] hover:bg-[rgb(var(--hover))] transition-colors text-sm"
        >
          重置筛选
        </button>
      </div>
