...
export const ProjectCard = ({
  ...
  return (
    <div className="bg-[rgb(var(--card))] border border-[rgb(var(--border))] lg:rounded-lg p-4 hover:bg-[rgb(var(--hover))] transition-all duration-150">
            ...
            {project.editingImage ? (
              ...
              <div className="relative group w-full">
                ...
                <button
                  ...
                  className="absolute top-2 right-2 p-2 rounded-full bg-[rgb(var(--card))]/80 text-[rgb(var(--text-muted))] hover:bg-[rgb(var(--hover))] hover:text-[rgb(var(--text))] transition-colors opacity-0 group-hover:opacity-100 dark:bg-[rgb(var(--card))]/80 dark:text-[rgb(var(--text-muted))] dark:hover:bg-[rgb(var(--card))] dark:hover:text-[rgb(var(--text))]"
                  title="编辑图片"
                >
