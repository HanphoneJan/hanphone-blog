...
export default function DocManagementPage() {
  ...
  const getTypeColor = (type: string) => {
    switch (type) {
      ...
      default: return 'text-[rgb(var(--text-muted))]'
    }
  }
    ...
    <div className="font-sans min-h-screen flex flex-col bg-[rgb(var(--bg))] text-[rgb(var(--text))] relative overflow-hidden">
      <main className="flex-1 w-full max-w-7xl mx-auto lg:px-2 lg:py-2 relative z-10">
        <div className="bg-[rgb(var(--card))]/80 backdrop-blur-sm lg:rounded-xl shadow border border-[rgb(var(--border))] overflow-hidden">
          {/* 顶部导航 */}
          <div className="px-4 py-3 border-b border-[rgb(var(--border))]" style={{ borderColor: 'rgb(var(--border))', backgroundColor: 'rgb(var(--muted))' }}>
          ...
          <div className="px-4 pb-4 min-h-[80vh]">
            ...
            {loading ? (
              <div className="bg-[rgb(var(--card))]/60 rounded-lg shadow overflow-hidden border border-[rgb(var(--border))] mt-3" style={{ backgroundColor: 'rgb(var(--card))', borderColor: 'rgb(var(--border))' }}>
                <div className="px-4 py-2 text-center text-[rgb(var(--text-muted))]">
            ...
            <div className="p-3 border-t border-[rgb(var(--border))] flex justify-between items-center shrink-0">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="px-3 py-1.5 rounded-lg bg-[rgb(var(--muted))]/60 hover:bg-[rgb(var(--muted))] text-sm"
                >
