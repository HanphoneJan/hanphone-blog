...
export function EditDialog({
  ...
  return createPortal(
    <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
      ...
      <div className="relative z-10 bg-[rgb(var(--card)/0.9)] border-[rgb(var(--border))]  rounded-xl border w-full max-w-4xl h-[80vh] flex flex-col shadow-2xl dark:bg-[rgb(var(--card)/0.9)] dark:border-[rgb(var(--border))]">
