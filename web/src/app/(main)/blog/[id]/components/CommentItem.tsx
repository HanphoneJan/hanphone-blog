          ...
          {showReplyInput && (
            <div className="mt-2 relative">
              <textarea
                ...
                className="w-full bg-[rgb(var(--card))] border border-[rgb(var(--border))] rounded-lg p-2 pr-28 blog-text-sm text-[rgb(var(--text))] placeholder-[rgb(var(--text-muted))] focus:outline-none focus:border-[rgb(var(--primary))] transition-colors resize-none h-24"
                maxLength={1000}
                autoFocus
              />
              <div className="absolute right-2 bottom-2 flex gap-2 items-center">
                <EmojiPicker getTextarea={() => replyTextareaRef.current} />
                <button
