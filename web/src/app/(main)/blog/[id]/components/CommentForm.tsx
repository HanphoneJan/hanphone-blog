  ...
  return (
    <div className="space-y-3">
      ...
      <textarea
        ...
        className={`comment-textarea w-full px-4 py-3 rounded-lg border bg-[rgb(var(--card))] blog-text-md text-[rgb(var(--text))] focus:outline-none focus:ring-2 focus:ring-[rgb(var(--primary))] transition-all resize-none
        ${
          !currentUser
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center gap-3">
          <EmojiPicker getTextarea={() => textareaRef.current} />
          <button
            onClick={onSubmit}
