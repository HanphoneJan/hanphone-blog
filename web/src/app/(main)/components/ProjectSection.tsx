          ...
          >
            <div className="relative h-48 overflow-hidden">
              <div className="relative w-full h-full transition-transform duration-500 group-hover:scale-110">
                ...
                {/* 遮罩层 */}
                <div className="absolute inset-0 bg-[rgb(var(--overlay))]/0 transition-colors duration-300 group-hover:bg-[rgb(var(--overlay))]/50" />
              </div>
              ...
              <div className="absolute inset-0 flex items-center justify-center opacity-0 translate-y-4 transition-all duration-300 group-hover:opacity-100 group-hover:translate-y-0">
                <div className="bg-white/20 p-3 rounded-full border border-white/30 shadow-2xl">
