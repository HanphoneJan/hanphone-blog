...
const SLIDER_CSS = `
  ...
  .bg-slider::-webkit-slider-runnable-track {
    ...
    background: linear-gradient(
      to right,
      rgb(var(--primary)) var(--pct, 0%),
      rgb(var(--border)) var(--pct, 0%)
    );
  }
  ...
  .bg-slider:hover::-webkit-slider-thumb {
    box-shadow: 0 2px 8px rgba(0,0,0,0.35);
  }
  .bg-slider:active::-webkit-slider-thumb {
  ...
  .bg-slider:hover::-moz-range-thumb {
    box-shadow: 0 2px 8px rgba(0,0,0,0.35);
  }
  .bg-slider:active::-moz-range-thumb {
    transform: scale(1.15);
  }
`;
